...
New-AzResourceGroupDeployment -ResourceGroupName $rgName -TemplateFile $pwd/az104-07-vm-template.json -TemplateParameterFile $pwd/az104-07-vm-parameters.json -AsJob


Get-Job | select Name, Command

Write-Host "Deploying resources to 'az104-07-rg0'"
