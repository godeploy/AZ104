...
New-AzResourceGroupDeployment -ResourceGroupName $rgNames[0] -TemplateFile $pwd/az104-06-vms-template.json -TemplateParameterFile $pwd/az104-06-vm-parameters.json -AsJob
